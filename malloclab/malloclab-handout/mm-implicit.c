...
#define DEBUG           0
#define FIND_STRATEGY   NEXT_FIT

#if FIND_STRATEGY == FIRST_FIT
#define FIND_FIT    first_fit
#elif FIND_STRATEGY == NEXT_FIT
#define FIND_FIT    next_fit
#elif FIND_STRATEGY == BEST_FIT
#define FIND_FIT    best_fit
#elif
#error "Invalid find strategy macro"
#endif
